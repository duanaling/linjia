                            ...
                            <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <a href="offonline_recom.html" class="h3">农家美食</a><a href="offonline_recom.html"><span id="asn">更多</span></a>
                                    </div>
                                    <c:forEach items="${finmss}" var="finms" >
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <a href="/linjia/selectByIdDetailServlet?id=${finms.id}">
                                                    <div class="box-img-hover">
                                                        <img src="images/${finms.img}" class="img-fluid" alt="Image">
                                                    </div>
                                                </a>
                                                <div class="why-text">
                                                    <h4>${finms.name}</h4>
...
<%--                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">--%>
<%--                                        <a href="offonline_recom.html" class="h3">农家民宿</a><a href="offonline_recom.html"><span id="asn">更多</span></a>--%>
<%--                                    </div>--%>

<%--                                    <c:forEach items="${finzss}" var="finzs" >--%>
<%--                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">--%>
<%--                                            <div class="products-single fix">--%>
<%--                                                <a href="/linjia/selectByIdDetailServlet?id=${finzs.id}">--%>
<%--                                                    <div class="box-img-hover">--%>
<%--                                                        <img src="images/${finzs.img}" class="img-fluid" alt="Image">--%>
<%--                                                    </div>--%>
<%--                                                </a>--%>
<%--                                                <div class="why-text">--%>
<%--                                                    <h4>${finzs.name}</h4>--%>
...
<%--                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">--%>
<%--                                        <a href="offonline_recom.html" class="h3">农家户外</a><a href="offonline_recom.html"><span id="asn">更多</span></a>--%>
<%--                                    </div>--%>


<%--                                    <c:forEach items="${finhws}" var="finhw" >--%>
<%--                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">--%>
<%--                                            <div class="products-single fix">--%>
<%--                                                <a href="/linjia/selectByIdDetailServlet?id=${finhw.id}">--%>
<%--                                                    <div class="box-img-hover">--%>
<%--                                                        <img src="images/${finhw.img}" class="img-fluid" alt="Image">--%>
<%--                                                    </div>--%>
<%--                                                </a>--%>
<%--                                                <div class="why-text">--%>
<%--                                                    <h4>${finhw.name}</h4>--%>
                    ...
                    <div class="filter-sidebar-left">
                        ...
                        <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            <!-- <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">认养蔬菜<small class="text-muted">(100)</small>
                            </a>
                                <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action active">大白菜<small class="text-muted">(50)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action"> 茄子<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">番茄<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">土豆<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">豆芽<small class="text-muted">(20)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">其他<small class="text-muted">(20)</small></a>
                            ...
                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="#sub-men2" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">农家美食<small class="text-muted">(100)</small>
                                </a>
                                <div class="collapse show" id="sub-men2" data-parent="#list-group-men">
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action active">烧烤类<small class="text-muted">(50)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">农家炒菜<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">火锅<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">特色面食<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">其他<small class="text-muted">(20)</small></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="#sub-men3" data-toggle="collapse" aria-expanded="false" aria-controls="sub-men2">农家民宿
                                    <small class="text-muted">(50)</small>
                                </a>
                                <div class="collapse" id="sub-men3" data-parent="#list-group-men">
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action"> 清静民宿<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">田园风格<small class="text-muted">(20)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">简朴民居<small class="text-muted">(20)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">小阁楼<small class="text-muted">(20)</small></a>

                                    </div>
                                </div>
                            </div>
                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="#sub-men4" data-toggle="collapse" aria-expanded="false" aria-controls="sub-men2">农家户外
                                    <small class="text-muted">(50)</small>
                                </a>
                                <div class="collapse" id="sub-men4" data-parent="#list-group-men">
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action"> 户外垂钓<small class="text-muted">(10)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">家庭野炊<small class="text-muted">(20)</small></a>
                                        <a href="#" class="list-group-item list-group-item-action">公司团建<small class="text-muted">(20)</small></a>
                                    </div>
                                </div>
                            </div>
