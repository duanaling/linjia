...
@WebServlet("/shuCaiServlet")
public class ShuCaiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      //调用imagesService完成查询
        ...
        System.out.println(finvs);

        //3.转发到brand.jsp
        request.getRequestDispatcher("/shopShuCai.jsp").forward(request,response);
